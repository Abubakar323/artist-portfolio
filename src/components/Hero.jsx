      ...
      <div className="container relative z-10 mx-auto my-auto flex flex-col items-center justify-center px-6 lg:flex-row">
        ...
        <div className="flex w-full flex-col items-start justify-center lg:w-1/2 lg:pr-12">
          ...
          <motion.div
            ...
            className="group mb-4 flex items-center gap-2.5 rounded-full border border-white/10 bg-gradient-to-r from-purple-500/5 to-cyan-500/5 px-4 py-1.5 backdrop-blur-md"
          >
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 10, repeat: Infinity, ease: 'linear' }}
            ...
            <span className="bg-gradient-to-r from-purple-300 to-cyan-300 bg-clip-text text-[11px] font-semibold uppercase tracking-widest text-transparent">
              CONTEMPORARY ARTIST
            </span>
          </motion.div>
            ...
            {textLines.map((line, index) => (
              <div key={index} className="overflow-hidden">
                <motion.h1
                  ...
                  className={`text-2xl font-black tracking-tight sm:text-3xl md:text-4xl lg:text-5xl xl:text-[3.25rem] leading-none ${
                    line.highlight 
                      ? 'bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent'
                      : 'text-white'
                  }`}
          ...
          <motion.p
            ...
            className="mb-6 max-w-md text-xs sm:text-sm md:text-base text-white/60 leading-relaxed"
          >
            Transforming ideas into extraordinary works of art through innovation, craftsmanship, and artistic excellence.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-row items-center gap-3 w-full sm:w-auto mb-6 lg:mb-0"
          >
            {/* Explore Gallery Button */}
            <motion.button
              onClick={() => scrollToSection("portfolio")}
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 px-4 py-3 sm:px-6 sm:py-3.5 font-semibold text-white text-xs sm:text-sm shadow-lg shadow-purple-500/10 transition-all duration-300 flex flex-1 sm:flex-none items-center justify-center cursor-pointer"
            >
              <span className="relative z-10 flex items-center gap-2 whitespace-nowrap">
                Explore Gallery
                <motion.span
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative rounded-xl border border-white/10 bg-white/5 px-4 py-3 sm:px-6 sm:py-3.5 font-semibold text-white text-xs sm:text-sm backdrop-blur-sm transition-all duration-300 flex flex-1 sm:flex-none items-center justify-center cursor-pointer whitespace-nowrap"
            >
              <span className="relative z-10">View Profile</span>
            </motion.button>
          </motion.div>
        ...
        <div className="relative mt-8 flex w-full items-center justify-center lg:mt-0 lg:w-1/2 px-4 sm:px-0">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.div
                className="absolute h-[260px] w-[260px] md:h-[380px] md:w-[380px] rounded-full border border-purple-500/10"
                animate={{ rotate: 360 }}
                transition={{ duration: 40, repeat: Infinity, ease: 'linear' }}
              />
              <motion.div
                className="absolute h-[220px] w-[220px] md:h-[310px] md:w-[310px] rounded-full border border-cyan-500/10"
                animate={{ rotate: -360 }}
                transition={{ duration: 30, repeat: Infinity, ease: 'linear' }}
              />
            </div>
            ...
            <motion.div
              ...
              className="relative transition-all duration-200 ease-out"
            >
              <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-transparent p-2.5 backdrop-blur-md">
                <div className="relative h-[240px] w-[190px] overflow-hidden rounded-2xl sm:h-[300px] sm:w-[240px] md:h-[380px] md:w-[300px]">
                  <img
                    src="https://images.unsplash.com/photo-1579783928621-7a13d66a62d1?w=800&auto=format&fit=crop&q=80"
                    alt="Artistic Creation"
                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
              ...
              <FloatingInfoCard
                className="absolute -right-3 top-1/3 sm:-right-8 md:-right-10"
                delay={1.0}
                icon={Brush}
                title="Projects"
                value="150+"
              ...
              <FloatingInfoCard
                className="absolute -bottom-2 left-1/2 -translate-x-1/2 sm:-bottom-4 sm:left-1/4 sm:translate-x-0"
                delay={1.2}
                icon={Feather}
                title="Clients"
                value="80+"
            ...
            {/* Decorative Orbs */}
            <FloatingOrb className="absolute -left-10 -top-10 sm:-left-16 sm:-top-16 h-20 w-20 sm:h-28 sm:w-28 bg-purple-500/10" delay={0.5} />
            <FloatingOrb className="absolute -right-10 bottom-6 sm:-right-16 sm:bottom-12 h-16 w-16 sm:h-24 sm:w-24 bg-cyan-500/10" delay={1.5} />
          </motion.div>
        </div>
      </div>
...
const FloatingInfoCard = ({ className, delay, icon: Icon, title, value, gradient }) => {
  return (
    <motion.div
      ...
      style={{ transformStyle: 'preserve-3d', translateZ: '50px' }}
      className={`min-w-[85px] sm:min-w-[110px] rounded-xl border border-white/10 bg-black/80 p-2 sm:p-3 backdrop-blur-md transition-colors duration-300 ${className}`}
    >
      <div className="flex items-center gap-1.5">
        <div className={`rounded-lg bg-gradient-to-br ${gradient} p-1 sm:p-1.5`}>
          <Icon className="h-3 w-3 text-white" />
        </div>
        <p className="text-[8px] sm:text-[9px] font-bold tracking-wider uppercase text-white/40">{title}</p>
      </div>
      <p className="mt-1 text-xs sm:text-base font-bold text-white">{value}</p>
    </motion.div>
  );
};
      ...
      <div className="relative flex flex-col items-center gap-1">
        <svg className="h-7 w-7 -rotate-90">
          ...
          <circle
            ...
            strokeDashoffset={69.1 - (69.1 * progress) / 100}
          />
          <defs>
            <linearGradient id="scrollGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgb(var(--c-primary-500))" />
