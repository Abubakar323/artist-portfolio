...
//                       required
//                       disabled={sending}
//                       className="bg-transparent border border-parchment/15 px-4 py-3 text-parchment font-body text-sm focus:outline-none focus:border-gold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
//                       placeholder="Full name"
//                     />
//                   </div>
//                   <div className="flex flex-col gap-2">
...
//                     disabled={sending}
//                     rows={6}
//                     className="bg-transparent border border-parchment/15 px-4 py-3 text-parchment font-body text-sm focus:outline-none focus:border-gold transition-colors resize-none disabled:opacity-50 disabled:cursor-not-allowed"
//                     placeholder="Tell me about your project, the type of artwork you'd like, any references, size preferences..."
//                   />
//                 </div>
...
//                   type="submit"
//                   disabled={sending}
//                   className="flex items-center justify-center gap-3 py-4 text-xs tracking-[0.25em] uppercase font-body font-medium transition-all duration-300 mt-2 bg-gold text-ink hover:bg-gold-light disabled:opacity-70 disabled:cursor-not-allowed"
//                 >
//                   {sending ? (
//                     <>
