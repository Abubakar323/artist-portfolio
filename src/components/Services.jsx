      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-24">
          <div
            ...
            style={{
              borderColor: "rgb(var(--c-primary-500)/0.2)",
              backgroundColor: "transparent"
            }}
          >
            <span
              className="text-[10px] uppercase tracking-[0.3em] font-medium"
              style={{ color: "rgb(var(--c-primary-500))" }}
            >
              ✦ Studio Offerings ✦
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
          {services.map((service, i) => {
            ...
            return (
              <div
                key={i}
                className="reveal group relative bg-white/5 border border-white/10 rounded-[1.5rem] p-9 min-h-[380px] flex flex-col justify-between transition-all duration-500 cursor-default shadow-[0_10px_30px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_50px_rgb(var(--c-primary-500)/0.08)] hover:border-purple-500/20 overflow-hidden"
                style={{ opacity: 0, transform: "translateY(20px)", transition: "all 0.8s cubic-bezier(0.16, 1, 0.3, 1)" }}
              >
        ...
        >
          ...
          <div className="text-center mb-20 relative z-10">
            ...
            >
              <span className="text-[10px] uppercase tracking-[0.3em] font-medium" style={{ color: "rgb(var(--c-primary-500))" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-8 relative z-10">
            {[
              ...
              <div key={p.step} className="text-center relative flex flex-col items-center">
                ...
                <div className="font-display text-5xl md:text-6xl font-extralight text-purple-400 drop-shadow-[0_2px_15px_rgb(var(--c-primary-500)/0.2)] mb-4 tracking-tighter select-none relative z-10">
                  {p.step}
                </div>
